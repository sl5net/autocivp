...
let original_Init = GuiInterface.prototype.Init;
GuiInterface.prototype.Init = function()
{
    this.autociv = {
        corpse: {
...
GuiInterface.prototype.autociv_setHealersInitialStanceAggressive = function (player, value)
{
    if (this.autociv)
        this.autociv.setHealersInitialStanceAggressive = value;
};
...
let original_ScriptCall = GuiInterface.prototype.ScriptCall;
GuiInterface.prototype.ScriptCall = function(player, name, args)
{
	if (name in autociv_exposedFunctions)
		return this[name](player, args);
	return original_ScriptCall.apply(this, arguments);
};
